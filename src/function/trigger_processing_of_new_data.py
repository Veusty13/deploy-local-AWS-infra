...
def lambda_handler(event, context) -> None:
    ...
    s3_folder_path_from = get_s3_path(bucket_name=BUCKET_NAME, path_in_bucket=NEW_DATA_FOLDER)
    s3_folder_path_to = get_s3_path(bucket_name=BUCKET_NAME, path_in_bucket=PROCESSING_FOLDER)
    ...
    for key_from in keys:
        try:
            ...
            s3_key_path_from = get_s3_path(bucket_name=BUCKET_NAME, path_in_bucket=key_from)
